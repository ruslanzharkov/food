...
import {fetchBusinessDetailRequest, fetchBusinessDetailSuccess, fetchBusinessDetailError} from './actions';

export const thunkGetBusinessDetailData = (businessId: string): ThunkAction<void, ApplicationMainState, null, Action<string>> =>
